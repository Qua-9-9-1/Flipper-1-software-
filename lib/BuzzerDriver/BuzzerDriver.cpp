...
void BuzzerDriver::init() { pinMode(_pin, OUTPUT); }

void BuzzerDriver::tone(uint16_t frequency, uint32_t duration) { ::tone(_pin, frequency); }

void BuzzerDriver::noTone() { ::noTone(_pin); }
